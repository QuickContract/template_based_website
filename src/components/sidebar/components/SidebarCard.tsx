	...
	return (
		<Flex
			...
			<Flex
				...
				<QuickContractLogo variant='compact' color='white' />
			</Flex>
			<Flex direction='column' mb='12px' align='center' justify='center' px='15px' pt='55px'>
				...
				<Text fontSize='14px' color={'white'} px='10px' mb='14px' textAlign='center'>
					Improve your contract management process and start doing more with <QuickContractLogo variant='compact' color='white' /> Pro!
				</Text>
			</Flex>
			<Link href='#'>
				<Button
