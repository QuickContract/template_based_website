	...
	return (
		<Flex display={{ base: 'flex', lg: 'none' }} alignItems='center'>
			...
			<Drawer
				...
				<DrawerOverlay />
				<DrawerContent w={{ base: '280px', sm: '285px' }} maxW={{ base: '280px', sm: '285px' }} bg={sidebarBackgroundColor}>
					<DrawerCloseButton
						zIndex='3'
						onClick={onClose}
					...
					/>
					<DrawerBody maxW={{ base: '280px', sm: '285px' }} px='0rem' pb='0'>
						<Scrollbars
							autoHide
							renderTrackVertical={renderTrack}
							renderThumbVertical={renderThumb}
