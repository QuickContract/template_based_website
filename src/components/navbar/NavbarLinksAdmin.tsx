		...
		<Flex
			...
			<Flex
				...
				<Flex align='center' justify='center' bg={ethBox} h='29px' w='29px' borderRadius='30px' me='7px'>
					<Icon color={ethColor} w='9px' h='14px' as={asIcon(FaEthereum)} />
				</Flex>
			...
			<Menu>
				<MenuButton p='0px'>
					<Icon mt='6px' as={asIcon(MdNotificationsNone)} color={navbarIcon} w='18px' h='18px' me='10px' />
				</MenuButton>
				<MenuList
					boxShadow={shadow}
					p='20px'
			...
			<Menu>
				<MenuButton p='0px'>
					<Icon mt='6px' as={asIcon(MdInfoOutline)} color={navbarIcon} w='18px' h='18px' me='10px' />
				</MenuButton>
				<MenuList
					boxShadow={shadow}
					p='20px'
