		...
		<Card justifyContent='center' alignItems='center' flexDirection='column' w='100%' mb='0px' {...rest}>
			<Flex align='center' justify='space-between' w='100%' pe='20px' pt='5px'>
				<Button bg={boxBg} fontSize='sm' fontWeight='500' color={textColorSecondary} borderRadius='7px'>
					<Icon as={asIcon(MdOutlineCalendarToday)} color={textColorSecondary} me='4px' />
					This month
				</Button>
				<Button
					ms='auto'
					...
					borderRadius='10px'
					{...rest}>
					<Icon as={asIcon(MdBarChart)} color={iconColor} w='24px' h='24px' />
				</Button>
			</Flex>
			<Flex w='100%' flexDirection={{ base: 'column', lg: 'row' }}>
				<Flex flexDirection='column' me='20px' mt='28px'>
					...
					<Flex align='center' mb='20px'>
						...
						<Flex align='center'>
							<Icon as={asIcon(RiArrowUpSFill)} color='green.500' me='2px' mt='2px' />
					...
					<Flex align='center'>
						<Icon as={asIcon(IoCheckmarkCircle)} color='green.500' me='4px' />
